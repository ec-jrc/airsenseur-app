...
.constant('CONFIG', {
	...
	treshold: 30, // ug/m3
	dataSources: [
		{APIEndPoint: "http://geo.irceline.be/sos/api/v1/", country:"Belgium", flagUri: "flag-Belgium.png"},
		{APIEndPoint: "http://sensorweb.demo.52north.org/sensorwebclient-webapp-stable/api/v1", country:"Sweden", flagUri: "flag-Sweden.png"},
		{APIEndPoint: "http://sensors.geonovum.nl/sos/api/v1/", country:"Netherlands", flagUri: "flag-Netherlands.png"},
		{APIEndPoint: "http://sossvr1.liberaintentio.com:8080/52nSOS/api/v1/", country:"AirSensEUR (JRC Ispra)", flagUri: "flag-UE.png"},
